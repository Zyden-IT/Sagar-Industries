        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            <span className="inline-flex w-fit items-center gap-2 rounded-full bg-accent-soft px-3 py-1.5 text-[11px] font-bold uppercase tracking-[2px] text-accent">
              <Calculator size={14} weight="bold" /> Smart Tools
            </span>
            ...
            <ul className="flex flex-wrap gap-2.5">
              {TOOLS.map((t) => (
                <li
                  key={t.label}
                  className="inline-flex items-center gap-2 rounded-full border border-theme bg-card px-3.5 py-2 text-[13px] font-semibold text-primary shadow-card"
                >
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.3 }}
            transition={{ duration: 0.6, ease: "easeOut" }}
            className="rounded-[var(--radius-card)] border border-theme bg-card p-6 shadow-card sm:p-8"
          >
            ...
            {/* results */}
            <div className="mt-7 grid grid-cols-3 gap-3 border-t border-theme pt-6">
              {[
                {
                  icon: ClockCountdown,
                  label: "Payback",
                ...
                <div
                  key={r.label}
                  className="rounded-[14px] border border-theme bg-soft p-3.5 text-center"
                >
                  ...
                  <p className="mt-0.5 text-[11px]! text-secondary">{r.label}</p>
                </div>
              ))}
            </div>
