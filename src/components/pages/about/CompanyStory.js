...
const CompanyStory = () => {
  return (
    <section className="relative section-py bg-theme">
      ...
      <div className="container relative z-10">
        ...
        <div className="mx-auto flex max-w-2xl flex-col items-center gap-3 text-center">
          <span className="text-xs font-bold uppercase tracking-[2px] text-accent">Our Story</span>
        ...
        <div className="relative mt-16 hidden aspect-[10/3] w-full md:block">
          ...
          {MILES.map((m) => (
            ...
            >
              ...
              <span className="absolute left-1/2 top-2 -translate-x-1/2 whitespace-nowrap text-sm font-bold text-primary transition-opacity duration-200 group-hover:opacity-0">
                {m.year}
              </span>

              {/* Popup (appears above the car on hover) */}
              <div className="pointer-events-none absolute bottom-16 left-1/2 z-30 w-56 -translate-x-1/2 -translate-y-2 rounded-[var(--radius-card)] border border-theme bg-card p-4 text-left opacity-0 shadow-card transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
        ...
        <div className="relative mt-12 md:hidden">
          ...
          <div className="flex flex-col gap-8">
            {MILES.map((m, i) => (
              ...
              >
                <span className="relative z-10 mt-1 h-6 w-6 shrink-0 rounded-full bg-orange-gradient shadow-orange ring-4 ring-[var(--color-bg)]" />
                <div>
