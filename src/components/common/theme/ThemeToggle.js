...
const ThemeToggle = ({ className = "" }) => {
  ...
  return (
    <button
      ...
      className={`btn relative grid h-10 w-10 shrink-0 cursor-pointer place-items-center overflow-hidden rounded-full border border-border bg-soft transition-all duration-300 hover:scale-105 hover:border-accent ${className}`}
    >
