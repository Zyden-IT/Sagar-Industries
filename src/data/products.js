...
export const MACHINES = [
  ...
  { slug: "automatic-paper-roll-to-sheet-cutting-machine", name: "Automatic Paper Roll To Sheet Cutting Machine", category: "Cutting", type: "Automatic", short: "Fully automated feeding and cutting for consistent output.", image: "/hero15.png", description: "Fully automated feeding and cutting deliver consistent, high-volume output with minimal operator intervention and repeatable accuracy." },
